...
<!--                                                <td>Mysql版本</td>-->
<!--                                                <td>大于等于5.7</td>-->
<!--                                                --><?php //echo $modelInstall->correctOrFail($modelInstall->checkMysql()) ?>
<!--                                                <td>建议使用Mysql 5.7.40版本</td>-->
<!--                                            </tr>-->
                                            <tr>
                                                <td>PDO_MYSQL</td>
                                                <td>支持 (强烈建议支持)</td>
                            ...
                            <?php if ($step == '5') { ?>
                                <div class="show" id="mounting-success">
                                    ...
                                    <div class="success-content">
                                        ...
                                        <div style="margin-top: 5px;font-size:14px;">版本号：1.5.0</div>
                                        <div class="tips">
